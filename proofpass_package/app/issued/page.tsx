    ...
    <PageShell>
      <section className="grid gap-8 lg:grid-cols-12 lg:items-start">
        <div className="space-y-8 lg:col-span-5">
          <div>
            <SectionLabel>Issuance and Anchoring</SectionLabel>
            <h1 className="mt-4 font-headline text-4xl font-bold tracking-tight">
              Securing your identity
            </h1>
            <p className="mt-4 max-w-sm text-base leading-7 text-on-surface-variant">
              The payload is encrypted, pinned, signed, and anchored. The user sees a
              clear status trail without exposing the underlying record.
            </p>
          </div>
        ...
        <div className="lg:col-span-7">
          <div className="relative overflow-hidden rounded-[2rem] bg-surface-container p-8 md:p-10">
          ...
          <div className="mt-6 rounded-2xl bg-surface-variant/40 p-4 ghost-border">
            <div className="font-label text-[10px] uppercase tracking-[0.18em] text-on-surface-variant">
